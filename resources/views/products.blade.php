                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" id="opening_pur_price" name="opening_pur_price"
                                            class="form-control ">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" id="opening_quantity" name="opening_quantity"
                                            class="form-control" value="0.00">
                                    </div>
                                    <div class="col">
                                        <label for="avg_pur_price">Average Purchase Price</label>
                                        <input type="number" id="avg_pur_price" name="avg_pur_price"
                                            class="form-control ">
                                    </div>
                                    <div class="col">
                                        <label for="overhead_exp">Overhead Expense</label>
                                        <input type="number" id="overhead_exp" name="overhead_exp"
                                            class="form-control ">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" id="overhead_price_pur" name="overhead_price_pur"
                                            class="form-control ">
                                    </div>
                                    <div class="col">
                                        <label for="overhead_price_avg">Overhead Price Average</label>
                                        <input type="number" id="overhead_price_avg" name="overhead_price_avg"
                                            class="form-control">
                                    </div>
                                    <div class="col">
                                        <label for="pur_price_plus_oh">Purchase Price + Overhead</label>
                                        <input type="number" id="pur_price_plus_oh" name="pur_price_plus_oh"
                                            class="form-control ">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" id="avg_price_plus_oh" name="avg_price_plus_oh"
                                            class="form-control ">
                                    </div>
                                    <div class="col">
