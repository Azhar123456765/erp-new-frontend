        ...
        <div class="top">
            <div class="fields">
                ...
                <div class="one">
                    ...
                    <input onkeydown="handleKeyPress(event)" style="border: none !important;" type="text" id="invoice#" name="unique_id" readonly value="<?php echo $rand = 'PV' . random_int(1, 9999); ?>" />
                </div>
                <div class="one">
