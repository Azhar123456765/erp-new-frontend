...
<div class="container"  id="invoiceForm" style="margin-top: -85px; padding-top: 5px; overflow-x: visible;">
    <form id="form">
        ...
        <div class="invoice">
            ...
            <div class="dup_invoice" onchange="addInvoice(1)">
                ...
                <div class="div">
                    <input class="<?php echo $counter; ?>return_qty" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' id="return_qty" name="return_qty[]" value="0.00"/>
                </div>
            ...
            <div class="dup_invoice" onchange="addInvoice2(1)">
                ...
                <div class="div">
                    <input type="number" step="any" min="0.00" style="text-align:right !important;" step='any' id="return_qty1" name="return_qty[]"  />
                </div>
...
">
    ...
    <a href="/s_med_invoice" class="edit add-more btn btn-secondary btn-sm" style="margin-left: 19px; "id="add_more_btn" data-bs-toggle="tooltip" 
