@extends('layout.app')  @section('title','Purchase Invoice (Return)')  @section('content')
...
">
    ...
    <a href="/arp_med_invoice" class="edit add-more  btn btn-secondary btn-sm" style="margin-left: 19px; display:none;"id="add_more_btn" data-bs-toggle="tooltip" 
            data-bs-placement="top" 
