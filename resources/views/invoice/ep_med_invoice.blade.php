    ...
    <form id="form">
        ...
        <div class="invoice">
            ...
            <div class="dup_invoice">
                ...
                <div class="div">
                    <input class="<?php echo $counter; ?>pur_price" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' value='0.00' id="pur_price" name="pur_price[]" required onchange='count2();  total_amount();' />
                </div>

                <div class="div">
                    <input class="<?php echo $counter; ?>pur_qty" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' value='0.00' id="pur_qty" name="pur_qty[]" onchange='qty(); per_unit2();' />
                </div>

                <div class="div">
                    <input class="<?php echo $counter; ?>dis_per" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' value='0.00' id="dis_per" name="dis_per[]" onchange='discount2();  total_amount();' />
                </div>
                <div class="div">
                    <input class="<?php echo $counter; ?>dis_amount" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' value="0.00" id="dis_amount" name="dis_amount[]" onchange='discount();  total_amount();' />
                </div>
                <div class="div">
                    <input class="<?php echo $counter; ?>exp_unit" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' value='0.00' id="exp_unit" name="exp_unit[]" />
                </div>

                <div class="div">
                    <input class="<?php echo $counter; ?>amount" type="number" step="any" min="0.00" style="text-align:right !important;" step='any' value='0.00' onchange='count();  total_amount();' id="amount" name="amount[]" />
                </div>
            </div> -->
